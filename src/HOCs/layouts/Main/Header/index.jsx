...
import logo from "../../../../assets/images/logoAGILITS.png";
...
const Header = () => {
  ...
  return (
    <>
      <header className="h-16 bg-white shadow-md px-4 fixed left-0 top-0 w-full z-header">
        <div className="h-full flex justify-between items-center">
          <nav className="h-full flex items-center drop-shadow-lg">
            <img src={logo} alt="AGILITS Logo" className="h-10 block md:block m-5" />
            <div
            ...
            >
              <Dropdown overlay={projectsMenu} trigger={["click"]}>
                <button className="text-blue-800 h-8  font-semibold py-1.5 px-2 hover:bg-blue-50 focus:bg-blue-100 rounded">
            ...
            <Button
              className="text-blue-800 hover:text-blue-700 focus:text-blue-700 h-8 font-semibold py-1.5 px-2 hover:bg-blue-50 focus:bg-blue-100 rounded border-0 shadow-none"
          ...
          <div className="flex items-center">
            ...
            >
              <Tooltip title="Settings">
                <Button
                  className="border-0 shadow-none hover:bg-blue-200 focus:bg-blue-200 hover:text-blue-20 focus:text-blue-100"
                  shape="circle"
                  icon={<SettingFilled />}
                />
              </Tooltip>
